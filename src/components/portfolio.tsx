  ...
  const projects = [
    {
      ...
      description: "AI-powered code generator using Anthropic LLM API and E2B Sandbox for live code rendering with real-time preview.",
    ...
    },
    {
      ...
      description: "Secure authentication system using NextAuth/Auth.js with multiple providers and session management.",
    ...
    },
    {
      ...
      description: "Real-time voice and video interaction with an AI agent using WebRTC and advanced speech recognition.",
    ...
    {
      title: "Canva Clone",
      description: "Browser-based design editor with Canva-like interface, layer management, and export functionality.",
    ...
    },
    {
      ...
      description: "Group chat system built with WebSockets for live communication with typing indicators and presence.",
    ...
    },
    {
      ...
      description: "Personal finance management tool for tracking income, expenses, and overall financial data with analytics.",
    ...
    },
    {
      ...
      description: "Public chat platform where all messages are visible to everyone, integrated with AI for smart suggestions.",
      ...
      <div className="relative">
        ...
        <nav className="max-w-5xl mx-auto px-8 py-8 flex justify-between items-center">
          ...
          <div className="hidden md:flex items-center space-x-1 border border-zinc-700 bg-zinc-800 rounded-2xl px-4 py-2">
            <a href="#about" className="text-zinc-400 hover:text-white px-4 py-2 text-sm transition-colors">About</a>
            <a href="#projects" className="text-zinc-400 hover:text-white px-4 py-2 text-sm transition-colors">Projects</a>
            <a href="#experience" className="text-zinc-400 hover:text-white px-4 py-2 text-sm transition-colors">Experience</a>
          </div>
        ...
        <section className="max-w-5xl mx-auto px-8 pt-20 pb-40">
          ...
          <p className="text-zinc-400 text-base max-w-2xl mt-8 leading-loose">
            Meet Sagar Gautham, a full-stack engineer with expertise in Next.js, React, MERN stack, and scalable APIs. 
            Building production-grade applications that thousands of users love.
          </p>
          ...
          <div className="flex flex-col md:flex-row gap-4 mt-20">
              ...
              {experiences.map((exp, i) => (
                <button
                  ...
                  className={`px-4 py-3 rounded-md flex items-center space-x-3 text-left transition-colors ${
                    i === 0 ? 'bg-zinc-800 text-white' : 'text-zinc-400 hover:text-white'
                  }`}
                >
            ...
            <div className="flex-1 md:pl-10">
              <h3 className="text-2xl font-bold text-zinc-100">
                {experiences[0].role}{' '}
                <span className="text-cyan-500">@ {experiences[0].company}</span>
              </h3>
              <div className="text-zinc-400 text-sm mt-2">{experiences[0].period}</div>
        ...
        <section id="projects" className="max-w-5xl mx-auto px-8 mb-20">
          <h2 className="text-3xl font-bold text-white mb-12">I've been building amazing things</h2>
        ...
        <footer className="border-t border-zinc-800 py-12 max-w-5xl mx-auto px-8">
          <div className="flex flex-col items-center space-y-6">
            <div className="flex items-center space-x-3">
              <span className="font-bold text-white text-xl">Sagar Gautham</span>
            </div>
